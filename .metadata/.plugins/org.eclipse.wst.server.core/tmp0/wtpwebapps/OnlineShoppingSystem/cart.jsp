...
<h1>Customer Functions:</h1>
	...
	<input type="submit" value="Display list of available products"/>
	</form><br/><br/>
	
	<form action="showCart">
	<input type="submit" value="Display the products from cart"/>
	</form><br/><br/>
	
	<!--  <form action="showproduct">
	<input type="submit" value="Display bill and pay bill"/>
	</form><br/><br/>-->
